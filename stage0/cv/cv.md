...
#### CV#1. Markdown & Git 
- [Требования и критерии оценки](cv1.md)
- [Советы по выполнению задания](cv1-hints.md)
...
- [Требования и критерии оценки](cv2.md)
- [Советы по выполнению задания](cv2-hints.md)
...
- форма проверки - автотест
#### CV#3. CV. Cross-Check 
- [Требования и критерии оценки](cv3.md)
- [Советы по выполнению задания](cv3-hints.md)
