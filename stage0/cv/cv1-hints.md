## Советы по выполнению задания СV#1
Советы не являются частью задания. Следуйте советам только в той мере, в которой они могут вам помочь. 

Если работа с git через консоль составляет трудность, первую и вторую части таска CV можно выполнить более простым способом, при помощи интерфейса GitHub

Преимущество этого способа в том, что нет необходимости устанавливать никакие программы.  
Этот способ работает всегда и выручает в тех случаях, когда с Git возникают проблемы.  
