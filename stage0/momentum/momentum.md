...
<kbd>![screenshot](images/momentum.jpg)</kbd>
...
- [0. Организация работы](stage0/momentum/momentum-hints.md)
- [1. Часы и календарь](stage0/momentum/momentum-time.md)
- [2. Приветствие](stage0/momentum/momentum-greeting.md)
- [3. Слайдер изображений](stage0/momentum/momentum-slider.md) 
- [4. Виджет погоды](stage0/momentum/momentum-weather.md)
- [5. Виджет "цитата дня"](stage0/momentum/momentum-quote.md)
- [6. Аудиоплеер](stage0/momentum/momentum-audio.md)
